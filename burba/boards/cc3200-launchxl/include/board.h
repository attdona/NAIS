...
/**
 * @defgroup    boards_cc3200 CC3200 launchpad
 * @ingroup     boards
...
/**
 * @brief api for sending through another channel bytes written to UART
 *
 *  Enabled only if the macro CUSTOM_WRITE_R is defined
 *
 * @param data to send
